...
deploy:
	...
	@FNOX_AGE_KEY=$$(cat ~/.config/fnox/age.txt | grep "AGE-SECRET-KEY") ssh -o SendEnv=FNOX_AGE_KEY ale@achih1 "cd /home/ale/landing-new-v2 && FNOX_AGE_KEY=$$FNOX_AGE_KEY docker compose up -d"
