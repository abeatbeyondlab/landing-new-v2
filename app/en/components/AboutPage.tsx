        ...
        <section className="pt-32 pb-20 bg-brand-dark text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6">
              {t('title').split(' ')[0]} <span className="text-blue-500">{t('title').split(' ')[1]} {t('title').split(' ').slice(2).join(' ')}</span>
            </h1>
        ...
        <section className="py-20 bg-slate-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold mb-6 text-slate-900">{t('missionTitle')}</h2>
